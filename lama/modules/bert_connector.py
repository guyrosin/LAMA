...
#
# from pytorch_pretrained_bert import BasicTokenizer, BertModel
import numpy as np
import torch
import torch.nn.functional as F
from lama.modules.base_connector import *
from transformers import BasicTokenizer, BertForMaskedLM, BertTokenizer
...
class Bert(Base_Connector):
    def __init__(self, args, vocab_subset=None):
        ...
        self.tokenizer = BertTokenizer.from_pretrained(
            dict_file, do_lower_case=do_lower_case
        )
        ...
        # no longer needed in the new transformers library
